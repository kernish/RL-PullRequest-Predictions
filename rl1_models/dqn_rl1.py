...
#SBATCH --job-name=dqn_23k_2p #optional name to give to your job
#SBATCH -c 1 # Number of CPUS requested. If omitted, the default is 1 CPU.
#SBATCH --gpus-per-node=1
#SBATCH --mem=58G # Memory requested in megabytes. If omitted, the default is 1024 MB.
#SBATCH --time=04-09:00:00 # Expected job run time (killed afterwards) default 3hrs. 02-01:22:40
#SBATCH --account=def-kahani
#SBATCH --output=R-%x.out #%x.%j for job id %j
#SBATCH --error=R-%x.err

#CUDA_LAUNCH_BLOCKING=1 python dqn_alt.py train_data.csv
